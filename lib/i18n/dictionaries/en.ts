...
- Use basic markdown for formatting (**bold**, lists, tables, \`code\`) and always answer in English.`,
  ...
  feedback: {
    title: "Rating",
    subtitle:
      "Your feedback helps us improve the platform: rate your experience and suggest improvements.",
    ratingTitle: "Rate your experience",
    ratingIntro: "How would you rate Atlas IA?",
    ratingExisting:
      "You have already rated the platform. You can update your rating at any time.",
    ratingSubmitted:
      "Thank you for your rating! It has been recorded alongside the rest of the community.",
    categoryLabel: "Category",
    ...
    suggestionsIntro:
      "Is there anything you would like us to add or change? Tell us.",
    suggestionTitleLabel: "Title",
    suggestionTitlePlaceholder: "A short summary of your suggestion",
    suggestionCategoryLabel: "Category",
    suggestionDescLabel: "Description",
    suggestionDescPlaceholder: "Explain your suggestion in detail...",
    submitSuggestion: "Submit suggestion",
    suggestionSuccess: "Thank you! Your suggestion has been sent.",
    suggestionXp: "You earned the Collaborator badge and 50 XP for your first suggestion.",
    mySuggestions: "My suggestions",
    noSuggestions: "You have not sent any suggestions yet.",
    statuses: {
      pending: "Pending",
      revisada: "Reviewed",
    ...
    errors: {
      ...
      ratingInvalid: "Select a score between 1 and 5 stars.",
      titleRequired: "Write a title for your suggestion.",
      descRequired: "Write a description for your suggestion.",
    },
    starAria: "Score of {value} out of 5",
    loading: "Loading...",
    docente: {
      title: "Ratings and suggestions",
      summaryMedia: "Average",
      summaryTotal: "Total",
