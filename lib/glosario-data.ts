...
export const GLOSARIO: GlosarioTermino[] = [
  { termino: "Agente de IA", definicion: "Un sistema de IA capaz de tomar decisiones y ejecutar acciones de forma autónoma para lograr un objetivo específico. Puede navegar internet, usar herramientas y ejecutar código.", categoria: "Conceptos" },
  ...
  { termino: "Aprendizaje Supervisado", definicion: "Un tipo de machine learning donde el modelo se entrena con datos etiquetados, es decir, datos que ya tienen la respuesta correcta. El modelo aprende a predecir la salida correcta.", categoria: "ML" },
  { termino: "Aprendizaje No Supervisado", definicion: "Un tipo de machine learning donde el modelo encuentra patrones en datos sin etiquetar, sin saber cuál es la respuesta correcta. Útil para clustering y segmentación.", categoria: "ML" },
  { termino: "Aprendizaje por Refuerzo", definicion: "Un tipo de machine learning donde un agente aprende a tomar decisiones mediante prueba y error, recibiendo recompensas por acciones correctas y castigos por incorrectas.", categoria: "ML" },
  ...
  { termino: "Contexto (ventana de contexto)", definicion: "La cantidad de información que un modelo de IA puede 'recordar' y considerar al generar una respuesta. Se mide en tokens. Un contexto más grande permite conversaciones más largas.", categoria: "Técnico" },
  ...
  { termino: "Dataset", definicion: "Un conjunto de datos utilizado para entrenar un modelo de IA. La calidad y cantidad del dataset determinan en gran medida la calidad del modelo resultante.", categoria: "Técnico" },
  ...
  { termino: "Few-shot prompting", definicion: "Técnica de prompting donde se proporcionan ejemplos del resultado esperado antes de pedir la tarea real. Ayuda a guiar al modelo hacia el formato deseado.", categoria: "Prompting" },
  { termino: "Fine-tuning", definicion: "El proceso de ajustar un modelo pre-entrenado con datos específicos para mejorar su rendimiento en una tarea concreta. Permite personalizar modelos generales.", categoria: "Técnico" },
  ...
  { termino: "Ingeniería de Prompt (Prompt Engineering)", definicion: "La disciplina de diseñar instrucciones optimizadas para obtener los mejores resultados de un modelo de IA. Incluye técnicas como few-shot, chain of thought y más.", categoria: "Prompting" },
  ...
  { termino: "Machine Learning", definicion: "Un enfoque de la IA donde los sistemas aprenden de los datos sin ser programados explícitamente para cada tarea. El modelo encuentra patrones en los datos y los usa para hacer predicciones.", categoria: "ML" },
  ...
  { termino: "Overfitting", definicion: "Cuando un modelo aprende demasiado bien los datos de entrenamiento, incluyendo ruido y detalles irrelevantes, y no generaliza bien a datos nuevos. Es un error común.", categoria: "ML" },
  ...
  { termino: "Perceptrón", definicion: "El tipo más simple de red neuronal, con una sola capa. Fue la base de las redes modernas. Por sí solo solo puede resolver problemas linealmente separables.", categoria: "ML" },
  { termino: "Pre-entrenamiento", definicion: "Fase inicial donde un modelo aprende de grandes cantidades de datos no etiquetados. Luego se afina (fine-tuning) para tareas específicas. Ahorra tiempo y recursos.", categoria: "Técnico" },
  ...
  { termino: "Sesgo (Bias)", definicion: "Error sistemático en un modelo de IA que favorece ciertos resultados sobre otros. Puede originarse en datos de entrenamiento desbalanceados o en el diseño del algoritmo.", categoria: "Limitaciones" },
  ...
  { termino: "Transfer Learning", definicion: "Técnica donde un modelo entrenado para una tarea se reutiliza como punto de partida para una tarea diferente pero relacionada. Ahorra tiempo de entrenamiento.", categoria: "Técnico" },
  { termino: "Tasa de aprendizaje", definicion: "Hiperparámetro que controla cuánto se ajustan los parámetros del modelo en cada paso del entrenamiento. Muy alta puede divergir, muy baja hace el entrenamiento lento.", categoria: "Técnico" },
  ...
  { termino: "Zero-shot prompting", definicion: "Técnica donde se le pide a la IA realizar una tarea sin proporcionar ejemplos previos. Funciona bien para tareas que el modelo ya entiende por su entrenamiento.", categoria: "Prompting" },
];
