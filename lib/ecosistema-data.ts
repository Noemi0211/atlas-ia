...
> = {
  ...
  imagen: {
    ...
    descripcion: "Herramientas que crean imágenes a partir de texto o editarlas",
    icono: "🎨",
  },
  "audio-video": {
  ...
  "no-code": {
    ...
    descripcion: "Plataformas para crear apps y automatizaciones sin programar",
    icono: "🧩",
  },
  productividad: {
...
export const HERRAMIENTAS: HerramientaIA[] = [
  {
    ...
    caracteristicas: [
      ...
      "Integración con browsing y código",
    ...
    debilidadPrincipal: "Puede ser vago en análisis muy profundos",
    popularidad: 10,
  },
  {
    id: "claude",
    ...
    caracteristicas: [
      ...
      "Más preciso y menos alucinaciones",
  ...
  },
  {
    ...
    empresa: "Google",
    categoria: "asistente-conversacion",
    descripcion: "El asistente multimodal de Google con contexto masivo e integración con todo el ecosistema Google.",
    caracteristicas: [
    ...
    idealPara: ["Documentos masivos", "Google Workspace", "Búsquedas", "Análisis multimodal"],
    precio: "freemium",
  ...
  },
  {
    ...
    categoria: "codigo",
    descripcion: "El asistente de código más extendido. Integra directamente en tu editor y sugiere código en tiempo real.",
    caracteristicas: [
  ...
  },
  {
    ...
    caracteristicas: [
      ...
      "Modo agent para tareas complejas",
      "Basado en VS Code (compatible)",
    ],
    idealPara: ["Desarrollo completo", "Proyectos grandes", "Refactoring"],
    precio: "freemium",
    precioDetalle: "Gratis limitado, Pro $20/mes",
    url: "https://cursor.sh",
    openSource: false,
    multimodal: false,
    fortalezaPrincipal: "Edición de código con IA profunda",
  ...
  },
  {
    ...
    openSource: false,
    multimodal: false,
    fortalezaPrincipal: "Fácil de usar con prompts en natural",
    debilidadPrincipal: "Menos control fino que Midjourney",
    popularidad: 8,
  },
  {
    id: "midjourney",
  ...
  },
  {
    ...
    idealPara: ["Podcasts", "Audiolibros", "Contenido audiovisual", "Accesibilidad"],
    precio: "freemium",
  ...
  },
  {
    ...
    empresa: "Make",
    categoria: "no-code",
    descripcion: "Plataforma visual de automatización. Conecta apps y crea flujos de trabajo complejos sin código.",
    caracteristicas: [
    ...
    precio: "freemium",
    precioDetalle: "Gratis (1000 ops/mes), desde $9/mes",
    url: "https://make.com",
    openSource: false,
    multimodal: false,
...
export const CRITERIOS_COMPARACION: CriterioComparacion[] = [
  {
    ...
    descripcion: "Qué tan fácil es empezar a usar la herramienta",
  ...
  },
  {
    id: "velocidad",
    nombre: "Velocidad",
    descripcion: "Qué tan rápido genera respuestas",
  ...
  },
  {
    ...
    descripcion: "Capacidad de adaptar la herramienta a necesidades específicas",
...
export const ARBOL_DECISION: DecisionNode[] = [
  ...
  },
  {
    ...
    descripcion: "Diferentes asistentes son mejores para diferentes tareas",
    opciones: [
